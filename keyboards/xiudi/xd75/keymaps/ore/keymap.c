...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_WBASE] = LAYOUT_ortho_5x15(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LPRN, KC_QUOT, KC_RPRN, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME, KC_UP,   KC_END,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_F13,  KC_LGUI, KC_LALT, WFN,     GRV_CTL, SPC_SFT, KC_LEFT, KC_DOWN, KC_RGHT, SPC_SFT, MIN_CTL, WFN,     KC_RALT, KC_RGUI, KC_F14
    ),
    ...
    [_MBASE] = LAYOUT_ortho_5x15(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LPRN, KC_QUOT, KC_RPRN, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME, KC_UP,   KC_END,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_HAEN, KC_LCTL, KC_LALT, MFN,     GRV_GUI, SPC_SFT, KC_LEFT, KC_DOWN, KC_RGHT, SPC_SFT, MIN_GUI, MFN,     KC_RALT, KC_RCTL, KC_HANJ
    ),
